...
import { errorHandler, getCredentials, getDroppedAsset, Visitor, World, Asset, DroppedAsset } from "../../utils/index.js";
    ...
    for (let i = 0; i < count; i++) {
      try {
        ...
        await DroppedAsset.drop(asset, {
          ...
          uniqueName: `lunch-swap-food|${foodDef.itemId}|${foodDef.rarity}|${Date.now()}|0`,
          urlSlug,
          isInteractive: true,
