...
**Goal:** Build a daily social trading game where players collect, swap, and assemble food items to complete their ideal balanced meal, with nutrition scoring, XP progression, variable reinforcement mechanics, and admin controls.
...
| 6.5 | [phase-6.5-engagement-ui.md](./phase-6.5-engagement-ui.md) | 18.5-18.7 | Mystery reveal, bonus wheel, hot streak UI |
...
**Total: ~30 tasks, 12 phases, TDD throughout.**
