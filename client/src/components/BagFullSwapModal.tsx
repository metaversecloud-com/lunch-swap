          ...
          {items.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isSelected && (
                  <span className="absolute top-1 right-1 text-red-500 font-bold text-xs bg-red-100 rounded-full px-1.5 py-0.5" aria-hidden="true">
                    SWAP
                  </span>
                )}
              </button>
          ...
          >
            ...
            {selectedItem.matchesIdealMeal && (
              <p className="text-xs text-amber-600 mt-1 font-medium">
                Warning: This item is part of your ideal meal!
              </p>
            )}
          </div>
        )}
