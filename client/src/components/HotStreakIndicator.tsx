...
export const HotStreakIndicator = ({
  streak,
  hotStreakActive,
}: HotStreakIndicatorProps) => {
            ...
            <span
              ...
              style={{
                animation: reducedMotion
                  ? "none"
                  : `hotStreakFlame 0.6s ease-in-out ${i * 0.1}s infinite alternate`,
  ...
  return (
    ...
    >
          ...
          style={{
            animation:
              isPulsing && !reducedMotion
                ? `hotStreakPulse 1s ease-in-out ${i * 0.15}s infinite alternate`
                : "none",
            display: "inline-block",
          }}
          aria-hidden="true"
      ...
      <span className="text-xs font-bold text-orange-800 ml-0.5">
        {streak}x
      </span>
