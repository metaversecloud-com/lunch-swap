      ...
      >
            ...
            return (
              <div
                ...
                className={`flex items-center gap-3 p-2.5 rounded-xl border-2 transition-all duration-200
                  ${item.collected
                    ? "bg-white shadow-sm"
                    : "bg-gray-50 opacity-50 border-dashed"
                  }`}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className={`font-semibold text-sm truncate ${item.collected ? "text-gray-800" : "text-gray-400"}`}>
                    {item.name}
                  </p>
        ...
        <div className="actions">
          ...
          <button
            ...
            onClick={onConfirm}
            aria-label="Submit your meal for scoring"
          >
            Submit Meal
          </button>
        </div>
